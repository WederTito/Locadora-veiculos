package br.unitins.locadora.servlet;
...
@WebServlet("/img-carro")
public class ImgCarroServlet extends HttpServlet {

	private static final long serialVersionUID = -3979044016834124963L;
	// /images
	public static final String PATH_IMAGES = File.separator + "images";
	// /images/carro
	public static final String PATH_IMAGES_CARRO = PATH_IMAGES + File.separator + "carro";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // C:\\Users\\Tito\\images\\carro\\
        String diretorio = System.getProperty("user.home") + File.separator + PATH_IMAGES_CARRO + File.separator;
        
        // montando a imagem com e endereco do servidor
        // /home/janio/images/carro/2.png
