...
public enum Funcao {
	...
	Funcao(int id, String label) {
		...
		if (id == 1) {
			...
			paginasComPermissao.add("/Locadora/faces/admin/endereco.xhtml");
			...
			paginasComPermissao.add("/Locadora/faces/admin/categoria.xhtml");
			paginasComPermissao.add("/Locadora/faces/admin/locacao.xhtml");
			paginasComPermissao.add("/Locadora/faces/admin/locacaolisting.xhtml");
			paginasComPermissao.add("/Locadora/faces/admin/categorialisting.xhtml");
			...
			paginasComPermissao.add("/Locadora/faces/admin/enderecolisting.xhtml");
